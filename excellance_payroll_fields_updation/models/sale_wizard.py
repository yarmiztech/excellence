    ...
    def create_sale_order(self):
        ...
        for task in task_list:
            ...
            if task.unit == 'Hour':
                ...
                unit_of_measure = self.env['uom.uom'].search([('name', '=', 'Hours')])[0]
                if unit_of_measure == None:
                    raise UserError('Please create unit of measure for "Hours"')
                print("uom",unit_of_measure)

                if self.env['uom.uom'].search([('name', '=', 'Hours')]):
                    unit_of_measure = self.env['uom.uom'].search([('name', '=', 'Hours')])[0]
                    print("uom", unit_of_measure)
            ...
            if task.unit == 'Monthly':
                ...
                # unit_of_measure = self.env['uom.uom'].search([('name', '=', 'Month')])[0]
                # if unit_of_measure == None:
                #     raise UserError('Please create unit of measure for "Month"')
                # print("uom",unit_of_measure)
                if self.env['uom.uom'].search([('name', '=', 'Month')]):
                    unit_of_measure = self.env['uom.uom'].search([('name', '=', 'Month')])[0]
                    print("uom", unit_of_measure)
            ...
            if task.unit == 'Daily':
                ...
                if self.env['uom.uom'].search([('name', '=', 'Days')]):
                    unit_of_measure = self.env['uom.uom'].search([('name', '=', 'Days')])[0]
                    print("uom", unit_of_measure)
